...
/**
 * Route serving create comment tables in the database.
 * @name post/admin/create_comments_db
 * @function
 * @memberof module:/api/v1_0/comment/admin
 * @inner
 ...
 */
router.post('/create_comments_db', async(ctx) => {
